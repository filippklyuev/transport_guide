...
void Test(){
    ...
    transport_guide::info::RoutingSettings routing_settings = json_reader::parser::parseRoutingSettings(all_requests.at("routing_settings").AsDict());
    json_reader::parser::StatParser stat_parser(catalogue, json_reader::parser::parseRenderSettings(all_requests.at("render_settings").AsDict()), routing_settings);
